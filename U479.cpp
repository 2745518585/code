...
int main()
{
    ...
    while(~scanf("%d",&z))
    {
        ...
        else if(z==3)
        {
            segment a,b;
            a.input(),b.input();
            if(!intSS(a,b)) printf("NO");
            else intLL(line(a.a,a.b-a.a),line(b.a,b.b-b.a)).print();
            printf("\n");
        }
        else if(z==4)
        {
            ...
            line b;
            a.input(),b.input();
            intLL(line(a,turnV(b.b,pi/2)),b).print();
            printf("\n");
        }
        else if(z==5)
        {
        ...
        else if(z==6)
        {
            ...
            segment b;
            a.input(),b.input();
            if(dcmp(dot(a-b.a,b.b-b.a))<=0) printf("%.2lf\n",disPP(a,b.a));
            else if(dcmp(dot(a-b.b,b.a-b.b))<=0) printf("%.2lf\n",disPP(a,b.b));
            else printf("%.2lf\n",disPP(a,intLL(line(a,turnV(b.b-b.a,pi/2)),line(b.a,b.b-b.a))));
        }
    }
    return 0;
}