...
void merge(int x1,int x2,int l,int r)
{
    ...
    int z=l+r>>1;
    if(T2[x1].l&&T2[x2].l) merge(T2[x1].l,T2[x2].l,l,z);
    else if(!T2[x1].l) T2[x1].l=T2[x2].l;
    if(T2[x1].r&&T2[x2].r) merge(T2[x1].r,T2[x2].r,z+1,r);
    else if(!T2[x1].r) T2[x1].r=T2[x2].r;
    pushup(x1);
}
